...
<script>
	...
	function init(){
		while(cards.length<52){
			const suitIdx = Math.floor(Math.random() * 4); //2
			const valueIdx = Math.floor(Math.random() * 13); //7
			const card = cardSuits[suitIdx] + ',' + cardValues[valueIdx]; // ♥,8
