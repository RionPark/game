...
<body>
<div id="init">
	<input type="text" id="name" placeholder="대화명"><button onclick="start()">시작</button>
</div>
...
const mesaages = document.querySelector('#messages');
var stomp = null;
function start(){
	...
	stomp.connect({}, function(con){
		...
		stomp.subscribe('/topic/message', function (data){
			...
			mesaages.value += message.name + ' : ' + message.message + '\r\n';
			console.log(data);
		})
	})
}
